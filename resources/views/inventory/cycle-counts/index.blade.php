<x-app-layout>
        ...
        <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            ...
            <div class="flex items-center gap-3">
                @can(\App\Enums\Permission::PerformCycleCount->value)
                    ...
                    <button type="button" @click="scheduleModal = true" class="inline-flex items-center gap-2 rounded-lg bg-emerald-600 px-3.5 py-2 text-sm font-semibold text-white shadow-sm hover:bg-emerald-700 transition">
    ...
    <div class="py-6" x-data="{ scheduleModal: false }">
                            ...
                            @empty
                                <tr>
                                    <td colspan="7" class="px-6 py-8 text-center text-sm text-neutral-500">
                                        No cycle count documents found. Click "Schedule Cycle Count" to generate an inventory audit.
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
                    ...
                    <form action="{{ route('inventory.cycle-counts.schedule') }}" method="POST">
                        ...
                        <div class="bg-white px-6 pt-6 pb-4">
                            ...
                            <div class="mt-6 space-y-4">
                                ...
                                <div>
                                    <label class="block text-xs font-semibold uppercase tracking-wider text-neutral-700">Assign Blind Counter</label>
