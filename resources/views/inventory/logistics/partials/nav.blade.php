...
<div
    class="rounded-xl border border-neutral-200 bg-white p-2.5 shadow-sm print:hidden"
...
>
    ...
    <div class="sm:hidden space-y-2">
        ...
        @canany([\App\Enums\Permission::ManageLogisticsRecords->value, \App\Enums\Permission::ViewLogisticsSensitiveData->value])
            <div class="flex flex-wrap items-center gap-2 pt-1 border-t border-neutral-100">
                @can(\App\Enums\Permission::ManageLogisticsRecords->value)
                    ...
                    <x-ui.button variant="secondary" size="sm" :href="route('inventory.logistics.shipments')" icon="plus" class="flex-1">
                        New Shipment
                    </x-ui.button>
                @endcan
                @can(\App\Enums\Permission::ViewLogisticsSensitiveData->value)
            ...
            @canany([\App\Enums\Permission::ViewLogisticsRecords->value, \App\Enums\Permission::ViewLogisticsSensitiveData->value])
                <div class="relative" @click.outside="if (openDropdown === 'ops') openDropdown = null">
                    <button
                        ...
                        class="inline-flex items-center gap-2 px-3.5 py-2 rounded-lg font-semibold transition border shadow-2xs {{ $isOpsActive ? 'bg-primary-50 text-primary-800 border-primary-200 ring-1 ring-primary-500/20' : 'bg-white text-neutral-700 border-neutral-200 hover:bg-neutral-50 hover:text-neutral-900' }}"
                    >
                        <x-ui.icon name="truck" class="h-4 w-4 {{ $isOpsActive ? 'text-primary-600' : 'text-neutral-500' }}" />
                    ...
                    >
                        @can(\App\Enums\Permission::ViewLogisticsRecords->value)
                            <a
                                ...
                                class="flex items-center justify-between px-3 py-2 rounded-lg text-xs font-medium transition {{ request()->routeIs('inventory.logistics') && !request()->routeIs('inventory.logistics.*') ? 'bg-primary-50 text-primary-800 font-semibold' : 'text-neutral-700 hover:bg-neutral-50' }}"
                            >
                        ...
                        @can(\App\Enums\Permission::ViewLogisticsSensitiveData->value)
                            <a
                                ...
                                class="flex items-center justify-between px-3 py-2 rounded-lg text-xs font-medium transition {{ request()->routeIs('inventory.logistics.documents*') ? 'bg-primary-50 text-primary-800 font-semibold' : 'text-neutral-700 hover:bg-neutral-50' }}"
                            >
                                <span class="flex items-center gap-2">
                            ...
                            <a
                                ...
                                class="flex items-center justify-between px-3 py-2 rounded-lg text-xs font-medium transition {{ request()->routeIs('inventory.logistics.shipments*') ? 'bg-primary-50 text-primary-800 font-semibold' : 'text-neutral-700 hover:bg-neutral-50' }}"
                            >
                                <span class="flex items-center gap-2">
                            ...
                            <a
                                ...
                                class="flex items-center justify-between px-3 py-2 rounded-lg text-xs font-medium transition {{ request()->routeIs('inventory.logistics.chain-of-custody*') ? 'bg-primary-50 text-primary-800 font-semibold' : 'text-neutral-700 hover:bg-neutral-50' }}"
                            >
                                <span class="flex items-center gap-2">
            ...
            @canany([\App\Enums\Permission::ViewLogisticsSensitiveData->value, \App\Enums\Permission::ViewReports->value, \App\Enums\Permission::ViewProcessReviews->value])
                <div class="relative" @click.outside="if (openDropdown === 'gov') openDropdown = null">
                    <button
                        ...
                        class="inline-flex items-center gap-2 px-3.5 py-2 rounded-lg font-semibold transition border shadow-2xs {{ $isGovActive ? 'bg-primary-50 text-primary-800 border-primary-200 ring-1 ring-primary-500/20' : 'bg-white text-neutral-700 border-neutral-200 hover:bg-neutral-50 hover:text-neutral-900' }}"
                    >
                        <x-ui.icon name="shield-check" class="h-4 w-4 {{ $isGovActive ? 'text-purple-600' : 'text-neutral-500' }}" />
                        <span>Compliance &amp; Governance</span>
                        <x-ui.icon name="chevron-down" class="h-3.5 w-3.5 text-neutral-400 transition-transform duration-200" ::class="openDropdown === 'gov' ? 'rotate-180' : ''" />
                    </button>
                    ...
                    >
                        @can(\App\Enums\Permission::ViewLogisticsSensitiveData->value)
                            <a
                                ...
                                class="flex items-center justify-between px-3 py-2 rounded-lg text-xs font-medium transition {{ request()->routeIs('inventory.logistics.iar*') ? 'bg-primary-50 text-primary-800 font-semibold' : 'text-neutral-700 hover:bg-neutral-50' }}"
                            >
                                <span class="flex items-center gap-2">
                        ...
                        @can(\App\Enums\Permission::ViewProcessReviews->value)
                            <a
                                ...
                                class="flex items-center justify-between px-3 py-2 rounded-lg text-xs font-medium transition {{ request()->routeIs('reviews.index', 'reviews.show', 'reviews.create') ? 'bg-primary-50 text-primary-800 font-semibold' : 'text-neutral-700 hover:bg-neutral-50' }}"
                            >
                                <span class="flex items-center gap-2">
                            ...
                            <a
                                ...
                                class="flex items-center justify-between px-3 py-2 rounded-lg text-xs font-medium transition {{ request()->routeIs('reviews.dpri*') ? 'bg-primary-50 text-primary-800 font-semibold' : 'text-neutral-700 hover:bg-neutral-50' }}"
                            >
                                <span class="flex items-center gap-2">
        ...
        @canany([\App\Enums\Permission::ManageLogisticsRecords->value, \App\Enums\Permission::ViewLogisticsSensitiveData->value])
            <div class="flex items-center gap-2 flex-wrap">
                @can(\App\Enums\Permission::ManageLogisticsRecords->value)
                    ...
                    <x-ui.button variant="secondary" size="sm" :href="route('inventory.logistics.shipments')" icon="plus">
                        New Shipment
                    </x-ui.button>
                @endcan
                @can(\App\Enums\Permission::ViewLogisticsSensitiveData->value)
