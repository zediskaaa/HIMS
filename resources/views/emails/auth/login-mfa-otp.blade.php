...
<head>
    ...
    <title>HIMS Login Verification Code</title>
</head>
            ...
            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:560px;background:#ffffff;border-radius:14px;overflow:hidden;border:1px solid #e5e5e5;">
                ...
                <tr>
                    <td style="padding:32px;">
                        <h1 style="margin:0;font-size:24px;line-height:32px;">Login verification</h1>
                        <p style="margin:16px 0 0;color:#525252;font-size:15px;line-height:24px;">Use this one-time code to finish signing in to HIMS:</p>
                        ...
                        <p style="margin:0;color:#525252;font-size:14px;line-height:22px;">This code expires in {{ $expiresInMinutes }} {{ Str::plural('minute', $expiresInMinutes) }} and can be used only once. Requesting another code invalidates this one.</p>
                        <p style="margin:18px 0 0;color:#737373;font-size:13px;line-height:20px;">Do not share this code. If you did not try to sign in, you can safely ignore this email and should review your account security.</p>
                    </td>
                </tr>
            </table>
        </td>
