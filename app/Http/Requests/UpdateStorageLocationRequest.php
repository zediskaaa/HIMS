...
class UpdateStorageLocationRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            'code' => ['nullable', 'string', 'max:100', 'regex:/^[A-Za-z0-9][A-Za-z0-9._-]*$/', Rule::unique('storage_locations', 'code')->ignore($locationId)],
            'parent_id' => ['nullable', 'integer', 'different:id', Rule::exists('storage_locations', 'id')],
            'type' => ['sometimes', Rule::in(['warehouse', 'zone', 'aisle', 'rack', 'shelf', 'level', 'bin', 'pharmacy', 'department'])],
            ...
            'capacity_unit' => ['sometimes', Rule::in(['units', 'boxes', 'pallets'])],
