...
class PrivacyGovernanceController extends Controller implements HasMiddleware
{
    ...
    /**
     * Mark a Data Subject Request as under active review.
     */
    public function markUnderReview(Request $request, PrivacyRequest $privacyRequest): RedirectResponse
    {
        $this->privacyRequestService->markUnderReview($privacyRequest, $request->user());

        return back()->with('status', "Data Subject Request #{$privacyRequest->ticket_number} placed under active review.");
    }

    /**
     * Approve a Data Subject Request and trigger full fulfillment workflow.
     */
    public function approveRequest(Request $request, PrivacyRequest $privacyRequest): RedirectResponse
    {
    ...
    /**
     * Safely regenerate a fulfillment package for an approved request.
     */
    public function regeneratePackage(Request $request, PrivacyRequest $privacyRequest): RedirectResponse
    {
        $this->privacyRequestService->approveAndFulfill(
            request: $privacyRequest,
            actor: $request->user(),
            notes: 'Fulfillment package refreshed and regenerated by authorized DPO.'
        );

        return back()->with('status', "Data Subject Request #{$privacyRequest->ticket_number} fulfillment package regenerated successfully.");
    }
